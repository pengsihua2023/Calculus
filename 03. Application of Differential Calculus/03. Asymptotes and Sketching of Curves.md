...
Here is the **curve sketching illustration** of the function

$$
f(x) = \frac{x}{x^2+1}
$$

which includes all the elements of “curve sketching”:
...
* **Green points: inflection points**

  * (- $\sqrt{3}, -0.29$)
  * (0,0)
  * ( $\sqrt{3}, 0.29$)

* **Blue dashed line: horizontal asymptote** (y=0)

Thus it fully shows the domain, symmetry, monotonicity, extrema, concavity, inflection points, and asymptotes.
